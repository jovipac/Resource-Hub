...
(function(global, factory) {
  ...
  strats.init = strats.created = strats.ready = strats.attached = strats.detached = strats.beforeCompile = strats.compiled = strats.beforeDestroy = strats.destroyed = strats.activate = function(
    parentVal,
    childVal
  ) {
    return childVal
  ...
  function initMixin(Vue) {
    ...
    Vue.prototype._init = function(options) {
      ...
      this._fragment = this._fragmentStart = this._fragmentEnd = null; // @type {DocumentFragment} // @type {Text|Comment} // @type {Text|Comment}
