...
(function() {
        ...
        on: function(b, d, g, l, k) {
          ...
          if (0 > f.getListenerIndex(d)) {
            ...
            for (var A = f.length - 1; 0 <= A; A--)
              if (f[A].priority <= k)
                return f.splice(A + 1, 0, n), { removeListener: w };
            f.unshift(n);
          }
  ...
  (function() {
    ...
    CKEDITOR.tools = {
      ...
      extend: function(a) {
        ...
        for (var k = 1; k < f; k++) {
          var d = arguments[k],
            q;
          for (q in d)
            if (!0 === b || null == a[q]) if (!c || q in c) a[q] = d[q];
        }
        return a;
      },
      ...
      enableHtml5Elements: function(a, b) {
        for (
          var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(
              " "
            ),
            k = c.length,
            d;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      getDocumentPosition: function(a) {
        ...
        if (document.documentElement.getBoundingClientRect) {
          var u = this.$.getBoundingClientRect(),
            ...
            l = !0;
          CKEDITOR.env.ie &&
            ((l = f.getDocumentElement().contains(this)),
          ...
          l &&
            ...
            (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
              ...
              : ((c = e ? d.$ : g), (b = c.scrollLeft), (c = c.scrollTop)),
            (b = u.left + b - y),
            (c = u.top + c - q));
        } else
          for (
            q = this, y = null;
            q && "body" != q.getName() && "html" != q.getName();
            ...
            for (; y && !y.equals(q); )
              (b -= y.$.scrollLeft), (c -= y.$.scrollTop), (y = y.getParent());
            y = q;
      ...
      scrollIntoParent: function(a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = l ? e.getBody() : e.getDocumentElement());
        e = a.getWindow();
        d = q(this, e);
        var t = q(a, e),
          z = this.$.offsetHeight;
      ...
      copyAttributes: function(a, b) {
        ...
        for (var f = 0; f < c.length; f++) {
          var d = c[f],
            ...
            u;
          if (!(e in b))
            if ("checked" == e && (u = this.getAttribute(e)))
              a.setAttribute(e, u);
            else if (!CKEDITOR.env.ie || this.hasAttribute(e))
              (u = this.getAttribute(e)),
  ...
  (function() {
            ...
            ? f.type == CKEDITOR.NODE_ELEMENT &&
              (f =
                0 < x
                  ...
                  : !1 === z(f, !0)
                  ? null
                  : f.getPreviousSourceNode(!0, p, z))
            : ((f = d),
              f.type == CKEDITOR.NODE_ELEMENT &&
                ((f = f.getChild(e)) ||
                  (f =
                    !1 === z(d, !0) ? null : d.getNextSourceNode(!0, p, z)))),
          f && !1 === z(f) && (f = null));
      for (; f && !this._.end; ) {
        this.current = f;
    ...
    var f = CKEDITOR.dom.walker.empty(),
      x = (CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(
        (function(a) {
          var b = {},
            c;
          ...
          : b.type == CKEDITOR.NODE_TEXT ||
            (b.type == CKEDITOR.NODE_ELEMENT &&
              (b.is(CKEDITOR.dtd.$inline) ||
                ...
                (!CKEDITOR.env.needsBrFiller && b.is(x) && f(b))))
          ? !0
          : !1;
        return !!(a ^ b);
      };
  ...
  (function() {
    ...
    function d(a, b, c, d, e) {
      ...
      function l() {
        ...
        b < E - 1 || b < L - 1 || c
          ? (c
              ? a.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START)
              : L == b + 1 && H
      ...
      var p = a.startContainer,
        ...
        M,
        Q;
      if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m))
        (p = a.document.createText(p.substring(C, r))), c.append(p);
      else {
        ...
        for (
          ...
          V = Z.getNext();
          for (
            O != E || (Z.equals(D[O]) && E < L)
              ? b && (ba = J.append(Z.clone(0, e)))
              : G
              ? q(Z, J, !1, w)
              : M && J.append(a.document.createText(Z.substring(C)));
            V;
        ...
        J = c;
        for (O = I; O <= L; O++)
          if (((c = D[O]), (V = c.getPrevious()), c.equals(v[O])))
            b && (J = J.getChild(0));
          else {
            O != L || (c.equals(v[O]) && L < E)
              ? b && (ba = J.append(c.clone(0, e)))
              : H
              ? q(c, J, !1, n)
              : Q && J.append(a.document.createText(c.substring(0, r)));
    ...
    CKEDITOR.dom.range.prototype = {
          ...
          if (d)
            if (d >= c.getLength()) (d = c.getIndex() + 1), (c = c.getParent());
              ...
              this.startContainer.equals(this.endContainer)
                ? this.setEnd(q, this.endOffset - this.startOffset)
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            r.type == CKEDITOR.NODE_TEXT
              ? (H &&
                  ((r = !CKEDITOR.tools.trim(r.substring(0, H)).length && r),
                  (C = !!r)),
                r && ((p = r.getPrevious()) || (h = r.getParent())))
              : (H && (p = r.getChild(H - 1) || r.getLast()), p || (h = r));
            for (h = c(h); h || p; ) {
              if (h && !p) {
                !m && h.equals(g) && (m = !0);
                if (e ? h.isBlockBoundary() : !l.contains(h)) break;
                (C && "inline" == h.getComputedStyle("display")) ||
                  ((C = !1), m ? (k = h) : this.setStartBefore(h));
                p = h.getPrevious();
              }
              for (; p; )
                if (((r = !1), p.type == CKEDITOR.NODE_COMMENT))
                  p = p.getPrevious();
                else {
                  if (p.type == CKEDITOR.NODE_TEXT)
                    ...
                    if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                      ...
                      if (d.test(G)) p = null;
                        ...
                        for (
                          var H = p.$.getElementsByTagName("*"), w = 0, n;
                          (n = H[w++]);

                        )
                          if (
                            !CKEDITOR.dtd.$removeEmpty[n.nodeName.toLowerCase()]
                          ) {
                            p = null;
                            break;
                          }
            ...
            m = C = !1;
            r.type == CKEDITOR.NODE_TEXT
              ? CKEDITOR.tools.trim(r.substring(H)).length
                ? (C = !0)
                : ((C = !r.getLength()),
                  H == r.getLength()
                    ? (p = r.getNext()) || (h = r.getParent())
                    : q(r, H) && (h = r.getParent()))
              : (p = r.getChild(H)) || (h = r);
            for (; h || p; ) {
              if (h && !p) {
                ...
                if (e ? h.isBlockBoundary() : !l.contains(h)) break;
                (C && "inline" == h.getComputedStyle("display")) ||
                  ((C = !1), m ? (z = h) : h && this.setEndAfter(h));
                p = h.getNext();
              }
              for (; p; ) {
                r = !1;
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var M,
              Q,
              v = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              M,
              !M.is("br") &&
                ((!h && this.checkStartOfBlock()) || (h && M.contains(h)))
            ...
            this.setEndAt(
              M,
              (!h && this.checkEndOfBlock()) || (h && M.contains(h))
      ...
      splitBlock: function(a, b) {
        ...
        "br" != a &&
          (e ||
            ((e = this.fixBlock(!0, a)),
            (q = new CKEDITOR.dom.elementPath(this.endContainer, this.root)
              .block)),
          q || (q = this.fixBlock(!1, a)));
        ...
        e &&
          ...
          (d
            ? ((g = new CKEDITOR.dom.elementPath(
              ...
              this.moveToPosition(q, CKEDITOR.POSITION_AFTER_END),
              (q = null))
            : c
            ? ((g = new CKEDITOR.dom.elementPath(
                this.startContainer,
  ...
  (function() {
    ...
    function b(a, c, e, g) {
      ...
      if (!g) return 0;
      if (
        (l = CKEDITOR.filter.instances[g.element.data("cke-filter")]) &&
        !l.check(c)
      )
    ...
    a.prototype = {
      getNextParagraph: function(a) {
        ...
        if (!this._.started) {
          ...
          l =
            q.endContainer.hasAscendant("pre", !0) ||
          ...
          q.collapsed ||
            ((l = new CKEDITOR.dom.walker(q.clone())),
            (y = CKEDITOR.dom.walker.bookmark(!0, !0)),
            (l.evaluator = y),
            (this._.nextNode = l.next()),
            (l = new CKEDITOR.dom.walker(q.clone())),
            (l.evaluator = y),
            (l = l.previous()),
            (this._.lastNode = l.getNextSourceNode(!0, null, q.root)),
            this._.lastNode &&
              ...
              ((y = this.range.clone()),
              y.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END),
              y.checkEndOfBlock() &&
                ((y = new CKEDITOR.dom.elementPath(y.endContainer, y.root)),
                (this._.lastNode = (y.block || y.blockLimit).getNextSourceNode(
                  !0
                )))),
            (this._.lastNode && q.root.contains(this._.lastNode)) ||
        ...
        for (this._.nextNode = null; y; ) {
          ...
          if (z) y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (z = 0);
            ...
            if (
              ...
              "false" == y.getAttribute("contenteditable")
            ) {
              d = y;
              b(this, a, d);
              break;
            } else if (
              y.isBlockBoundary(this.forceBrBreak && !t && { br: 1 })
            ) {
              if ("br" == p) z = 1;
              ...
              l &&
                (l.setEndAt(y, CKEDITOR.POSITION_BEFORE_START),
                "br" != p && (this._.nextNode = y));
              F = 1;
            } else {
              if (y.getFirst()) {
                l ||
                  ((l = this.range.clone()),
                  l.setStartAt(y, CKEDITOR.POSITION_BEFORE_START));
                y = y.getFirst();
                continue;
              }
              z = 1;
        ...
        if (!d) {
          ...
          !y.equals(l.root)
            ...
            ? (l.checkStartOfBlock() && l.checkEndOfBlock()) ||
              ...
              l.insertNode(d))
            : A ||
              (this._.nextNode = d.equals(q)
                ? null
                : this._getNextSourceNode(l.getBoundaryNodes().endNode, 1, q));
        }
        u &&
          (u = d.getPrevious()) &&
        ...
        B &&
          ...
          u.type == CKEDITOR.NODE_ELEMENT &&
          "br" == u.getName() &&
          (!CKEDITOR.env.needsBrFiller || u.getPrevious(g) || u.getNext(g)) &&
          u.remove();
        this._.nextNode ||
          (this._.nextNode =
            A || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
        return d;
      },
  ...
  (function() {
    function a(a, b, c, d, e) {
      ...
      for (h in b) {
        ...
        for (q in Q) {
          ...
          for (L in g)
            "!" == L.charAt(0) &&
              ((L = L.slice(1)), C.push(L), (z[L] = !0), (G = !1));
          for (; (L = C.pop()); ) (g[L] = g["!" + L]), delete g["!" + L];
          f[E] = (G ? !1 : z) || null;
        }
      ...
      for (d = a.length; c < d; ++c) {
        ...
        if (!0 === h.elements || null === h.elements)
          e[p ? "unshift" : "push"](h);
        else
    ...
    function k(a, b) {
      ...
      if ((h = a.requiredClasses))
        for (p = b.classes, c = 0; c < h.length; ++c)
          ...
          } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(p, d))
            return !1;
      return (
    ...
    function f(a) {
      var b,
        ...
        p = {},
        e = 1;
      for (a = R(a); (b = a.match(D)); )
        (c = b[2])
          ? ((d = x(c, "styles")), (h = x(c, "attrs")), (c = x(c, "classes")))
          : (d = h = c = null),
          (p["$" + e++] = {
            elements: b[1],
            classes: c,
    ...
    function z(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || H.$block[a.name])
      );
    }
    function h(a, b, c) {
      var d = a.name;
      if (H.$empty[d] || !a.children.length)
        "hr" == d && "br" == b
          ? a.replaceWith(t())
          : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
      else if (H.$block[d] || "tr" == d)
        if ("br" == b)
          a.previous && !z(a.previous) && ((b = t()), b.insertBefore(a)),
          ...
          if (h)
            ...
            for (
              var p =
                  h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name,
                r,
                g,
                e = d.length;
              0 < e;
              ...
              (m = d[--e]),
                p &&
                (m.type == CKEDITOR.NODE_TEXT ||
                  (m.type == CKEDITOR.NODE_ELEMENT && H.$inline[m.name]))
                  ? (r ||
                  ...
                  : ((r = null),
                    (g = H[h.name] || H.span),
                    m.insertAfter(a),
                    h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT ||
    ...
    function m(a, b) {
      ...
      for (p in d)
        if ("class" == p)
          for (
            c = d[p].split(/\s+/), m = a.classes.join("|");
            (r = c.pop());
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        !0 === b
          ...
          : (b || (this.customConfig = !1),
            ...
            this.allow(
              M[a.enterMode] + " " + M[a.shiftEnterMode],
              "default",
              1
            ),
          ...
          function(a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                1 == d.children.length &&
                  (h = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  u(p, h, c, f);
                c = !c.length;
              }
              c || e.push(a);
        ...
        for (; (q = a.pop()); )
          if (((c = q.el), c.parent))
            switch (((z = H[c.parent.name] || H.span), q.check)) {
              case "it":
                H.$removeEmpty[c.name] && !c.children.length
                  ? h(c, d, a)
                  : y(c) || h(c, d, a);
                break;
              case "el-up":
      ...
      check: function(a, b, c) {
        ...
        if ("string" == typeof a) {
          ...
          (d = a.getDefinition()),
            ...
            (m = d.attributes || {}),
            h
              ? ((h = K(h)), (m.style = CKEDITOR.tools.writeCssText(h, !0)))
              : (h = {}),
            (h = {
              name: d.element,
              attributes: m,
        ...
        b =
          0 < r.length
            ? !1
            : CKEDITOR.tools.objectCompare(h.attributes, m.attributes, !0)
            ? !0
            : !1;
        ...
        transform: function(a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (p in h)
              if ("class" == p)
                for (
                  c = a.classes.join("|"), e = h[p].split(/\s+/);
                  (r = e.pop());

                )
                  -1 == c.indexOf(r) && a.classes.push(r);
  ...
  (function() {
    var a,
      d = function(b) {
        ...
        a ||
          (g && (a = !1 !== l.execCommand(g, { from: "keystrokeHandler" })),
                    ...
                    (CKEDITOR.env.ie && 11 > CKEDITOR.env.version
                      ? (g.$.onreadystatechange = function() {
                          if (
                            ...
                            (g.$.onreadystatechange = null), A(b, !0);
                        })
                      : ((g.$.onload = function() {
                          setTimeout(function() {
                            A(b, !0);
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    load: function(a, d, b) {
      ...
      for (
        var c = this.loaded, e = this.registered, g = [], l = {}, k = {}, n = 0;
        n < a.length;
        n++
      ) {
        var w = a[n];
            ...
            a.call(
              ...
              function(a) {
                ...
                for (f in a) {
                  ...
                  if (!d[f]) {
                    if (k.icons)
                      for (var u = k.icons.split(","), B = u.length; B--; )
  ...
  (function() {
      ...
      CKEDITOR.plugins.load(c.split(","), function(c) {
        ...
        for (var g in c) {
          ...
          z &&
            !a.lang[g] &&
            (z.split && (z = z.split(",")),
            0 <= CKEDITOR.tools.indexOf(z, a.langCode)
              ? (l = a.langCode)
              : ((l = a.langCode.replace(/-.*/, "")),
                (l =
                  l != a.langCode && 0 <= CKEDITOR.tools.indexOf(z, l)
                    ? l
                    : 0 <= CKEDITOR.tools.indexOf(z, "en")
                    ? "en"
                    : z[0])),
            f.langEntries && f.langEntries[l]
              ? ((a.lang[g] = f.langEntries[l]), (l = null))
              : e.push(CKEDITOR.getUrl(f.path + "lang/" + l + ".js")));
          h.push(l);
          d.push(f);
        }
          ...
          for (
            ...
            for (var p = 0; p < d.length; p++) {
              ...
              0 === e &&
                ...
                m.lang &&
                m.langEntries &&
                (a.lang[m.name] = m.langEntries[h[p]]);
              if (m[c[e]]) m[c[e]](a);
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      getSelectedHtml: function(a) {
        ...
        for (
          var d = new CKEDITOR.dom.documentFragment(), e, h, p, m = 0;
          m < c.length;
          m++
        ) {
          var g = c[m],
            r = g.startContainer;
          r.getName && "tr" == r.getName()
            ? (e ||
                ((e = r.getAscendant("table").clone()),
                e.append(r.getAscendant("tbody").clone()),
                d.append(e),
                (e = e.findOne("tbody"))),
              (h && h.equals(r)) || ((h = r), (p = r.clone()), e.append(p)),
              p.append(g.cloneContents()))
            : d.append(g.cloneContents());
        }
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function(g, l, k) {
      function n(a) {
        ...
        if (0 < y.length)
          for (var c = 0; c < y.length; c++) {
            ...
            (g && !g[h]) || (a && e && !e[a] && CKEDITOR.dtd[a])
              ? h == t.name && (x(t, t.parent, 1), c--)
              : (b || (w(), (b = 1)),
                (d = d.clone()),
                (d.parent = t),
                (t = d),
      ...
      function x(b, c, d) {
        ...
        var e = t;
        void 0 === b.previous &&
          (A(c, b) && ((t = c), B.onTagOpen(k, {}), (b.returnPoint = c = t)),
          f(b),
          (a(b) && !b.children.length) || c.add(b),
          "pre" == b.name && (h = !1),
          "textarea" == b.name && (z = !1));
        b.returnPoint
          ? ((t = b.returnPoint), delete b.returnPoint)
          : (t = d ? c : e);
      }
      function A(a, b) {
        if (
              ...
              if (t.isOptionalClose) B.onTagClose(g);
                ...
                (g = t.children),
                  ((g = g[g.length - 1]) && "li" == g.name) ||
                    x((g = new CKEDITOR.htmlParser.element("li")), t),
                  !m.returnPoint && (m.returnPoint = t),
                  (t = g);
              else if (e in CKEDITOR.dtd.$listItem && !u(e, g))
                B.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
              else if (g in d && !u(e, g))
                !m.returnPoint && (m.returnPoint = t), (t = t.parent);
              else if ((g in CKEDITOR.dtd.$inline && y.unshift(t), t.parent))
                x(t, t.parent, 1);
              else {
                m.isOrphan = 1;
                break;
      ...
      B.onText = function(a) {
        if (
          !((t._.hasInlineStarted && !F.length) || h || z) &&
    ...
    a.prototype = {
      ...
      addMany: function(a, c, d) {
        for (var g = [this.findIndex(c), 0], l = 0, k = a.length; l < k; l++)
          g.push({ value: a[l], priority: c, options: d });
  ...
  (function() {
        ...
        return function(h) {
          if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var e = [],
              ...
              v;
            if (p)
              for (f(p, 1) && e.push(p); p; )
                g(p) &&
                  (r = c(p)) &&
                  f(r) &&
                  ((v = c(r)) && !g(v)
                    ? e.push(r)
                    : (m(z).insertAfter(r), r.remove())),
                  (p = p.previous);
              ...
              h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
                ? z ||
                  ...
                  !(
                    ...
                    h.name in CKEDITOR.dtd.tr ||
                    h.name in CKEDITOR.dtd.$listItem
                  )
                  ? ((e = b(h)),
                    (e = !e || ("form" == h.name && "input" == e.name)))
                  : (e = !1)
                : (e = !1);
            e && h.add(m(a));
          }
      ...
      function f(a, b) {
        ...
        return a.type == CKEDITOR.NODE_TEXT &&
          ...
          (c.index &&
            ...
            (a.value = c[0])),
          (!CKEDITOR.env.needsBrFiller && z && (!b || a.parent.name in v)) ||
            (!z && (((c = a.previous) && "br" == c.name) || !c || g(c))))
          ? !0
          : !1;
      }
      var r = { elements: {} },
    ...
    function g(a) {
      return (
        a &&
        ((a.type == CKEDITOR.NODE_ELEMENT && a.name in h) ||
    ...
    function w(a) {
      return a.replace(G, function(a, b, c) {
        return (
          "\x3c" +
          b +
          c.replace(H, function(a, b) {
            return K.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
      ...
      b.on(
        ...
        function(a) {
          ...
          CKEDITOR.env.ie &&
            9 > CKEDITOR.env.version &&
            "pre" == h &&
            ((h = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (e = 1));
          ...
          h &&
            ((e = c),
            !e.children.length &&
              CKEDITOR.dtd[e.name][h] &&
              ((h = new CKEDITOR.htmlParser.element(h)), e.add(h)));
          a.dataValue = c;
        },
        null,
        null,
          ...
          $: function(a) {
            ...
            if (b) {
              ...
              for (var c = ["name", "href", "src"], d, h = 0; h < c.length; h++)
                (d = "data-cke-saved-" + c[h]), d in b && delete b[c[h]];
            }
            return a;
          },
          table: function(a) {
  ...
  (function() {
    ...
    function b(a) {
      ...
      l &&
        a.ui.space("contents").setStyle("height", CKEDITOR.tools.cssLength(l));
    ...
    CKEDITOR.editor.prototype.setMode = function(a, b) {
      ...
      if (a != d.mode && l && l[a]) {
        ...
        if (d.mode) {
          ...
          "source" == d.mode &&
            l == n &&
            (d.fire("lockSnapshot", { forceUpdate: !0 }), (w = 1));
      ...
      proto: {
        ...
        setup: function() {
          ...
          if (!this.is("textarea")) {
            ...
            m &&
              ((e = d.getHead()),
              e.getCustomData("stylesheet") ||
                ((m = d.appendStyleText(m)),
                    ...
                    e[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
                      ? (a.fire("saveSnapshot"),
                        e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
                          p.remove(),
                        e["moveToElementEdit" + (c ? "End" : "Start")](k),
                        e.select(),
                        a.fire("saveSnapshot"),
                        (d = 1))
                      : m.blockLimit &&
                        m.blockLimit.is("td") &&
                        (v = m.blockLimit.getAscendant("table")) &&
                        e.checkBoundaryOfElement(
                          v,
                          c ? CKEDITOR.START : CKEDITOR.END
                        ) &&
                        (k = v[c ? "getPrevious" : "getNext"](f))
                      ? (a.fire("saveSnapshot"),
                        e["moveToElementEdit" + (c ? "End" : "Start")](k),
            ...
            CKEDITOR.env.gecko &&
              this.attachListener(this, "mouseup", function(b) {
                if (
                  2 == b.data.$.button &&
                  ((b = b.data.getTarget()), !b.getOuterHtml().replace(B, ""))
                ) {
                  var c = a.createRange();
                    ...
                    if (d.collapsed)
                      a: {
                        ...
                        if (
                          ...
                          d.moveToClosestEditablePosition(h, !c) &&
                          d.collapsed
                        ) {
                          if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                            var e = d.startContainer.getChild(
                              d.startOffset - (c ? 1 : 0)
                            );
                            if (
                              e &&
      ...
      q = (function() {
                  ...
                  K && f in CKEDITOR.dtd.$list
                    ...
                    : ((p = !!l[f]),
                      "br" != f ||
                        ...
                        (r && r != C - 1) ||
                        ((w =
                          (m = r ? g[r - 1].node : k.getItem(r + 1)) &&
                          (!a(m) || !m.is("br"))),
                        (m = m && a(m) && q.$block[m.getName()])),
                      -1 != G || p || (G = r),
                      p || (n = r),
                      g.push({
                        isElement: 1,
        ...
        function f(b) {
          return (
            b &&
            a(b) &&
            (b.is(q.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
          );
        }
        function g(b, c, d, e) {
          var h = b.clone(),
          ...
          (m = new CKEDITOR.dom.walker(h).next()) &&
            a(m) &&
            n[m.getName()] &&
            (f = m.getPrevious()) &&
            a(f) &&
            ...
            e.contains(m) &&
            m.isIdentical(f) &&
            (m.moveChildren(f), m.remove(), g(b, c, d, e));
        }
        function G(b, c) {
          function d(b, c) {
            if (
        ...
        return function(n, v, D, I) {
          ...
          if (!I.checkReadOnly()) {
            var J =
              new CKEDITOR.dom.elementPath(I.startContainer, I.root)
                .blockLimit || I.root;
            n = {
              type: v,
              dontFilter: L,
            ...
            if ((K = D)) {
              ...
              if ("text" == n.type && n.inlineStylesRoot) {
                ...
                for (I = n.inlineStylesRoot.getParent(); !u.equals(I); )
              ...
              if (
                ...
                a: {
                  ...
                  if (
                    ...
                    a((x = u.getFirst())) &&
                    x.is(w) &&
                    !x.hasAttribute("contenteditable")
                  ) {
            ...
            if (K) {
              ...
              var L = n.endPath.elements[0],
                ...
                J = L.getPosition(v),
                y =
                  !!L.getCommonAncestor(v) &&
                  J != CKEDITOR.POSITION_IDENTICAL &&
                  !(
                    J &
              ...
              for (G(v, x); I < v.length; I++) {
                ...
                if ((t = J.isLineBreak)) {
                  ...
                  J.hasBlockSibling
                    ? (t = 1)
                    : (S = t.startContainer.getAscendant(q.$block, 1)) &&
                      S.is({ div: 1, p: 1 })
                    ? ((aa = S.getPosition(F)),
                      ...
                      aa == CKEDITOR.POSITION_CONTAINS
                        ? (t = 0)
                        : ((F = t.splitElement(S)),
                          t.moveToPosition(F, CKEDITOR.POSITION_AFTER_START),
                          (t = 1)))
                    : (t = 0);
                }
                if (t) D = 0 < I;
                  ...
                  t = x.startPath();
                  !J.isBlock &&
                    l(n.editor, t.block, t.blockLimit) &&
                    (T = k(n.editor)) &&
                    ((T = K.createElement(T)),
                    T.appendBogus(),
                    x.insertNode(T),
                    CKEDITOR.env.needsBrFiller &&
                      (B = T.getBogus()) &&
                      B.remove(),
                    x.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
                  ...
                  J.lastNotAllowed &&
                    I < v.length - 1 &&
                    ((W = y ? L : W) &&
                      x.setEndAt(W, CKEDITOR.POSITION_AFTER_START),
                    (E = 0));
                  x.collapse();
                }
              }
              1 != v.length
                ...
                : ((B = v[0]),
                  (B =
                    B.isElement &&
                    "false" == B.node.getAttribute("contenteditable")));
              B &&
                ((D = !0),
                (t = v[0].node),
                x.setStartAt(t, CKEDITOR.POSITION_BEFORE_START),
                x.setEndAt(t, CKEDITOR.POSITION_AFTER_END));
              n.dontMoveCaret = D;
            ...
            for (X = B.createBookmark(); (N = n.zombies.pop()); )
              N.getParent() &&
                ((T = B.clone()),
        ...
        return {
          list: {
            detectMerge: function(a, b) {
              ...
              a.mergeList =
                f && g && f.getParent().equals(g.getParent()) && !f.equals(g);
              a.mergeListItems =
                e.block &&
                h.block &&
                e.block.is(CKEDITOR.dtd.$listItem) &&
                h.block.is(CKEDITOR.dtd.$listItem);
              ...
              detectPurge: function(a) {
                ...
                if (1 < e) {
                  ...
                  c &&
                    ...
                    b.checkBoundaryOfElement(h, CKEDITOR.END) &&
                    ((b = a.range.clone()),
                    b.setStartBefore(c),
                    b.setEndAfter(h),
                ...
                if (v || k)
                  v && k && b(v, k)
                    ...
                    ? k ||
                      ((e.tableSurroundingRange = g),
                      g.setStartAt(v, CKEDITOR.POSITION_AFTER_END),
                      f.setEndAt(v, CKEDITOR.POSITION_AFTER_END))
                    : ((e.tableSurroundingRange = g),
                      g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START),
                      f.setStartAt(k, CKEDITOR.POSITION_AFTER_START)),
      ...
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          ...
          d &&
            ...
            (f >= d.getLength() ? l.setStartAfter(d) : l.setStartBefore(d));
          e &&
            e.type == CKEDITOR.NODE_TEXT &&
            (g ? l.setEndAfter(e) : l.setEndBefore(e));
          ...
          d.evaluator = function(d) {
            if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
              ...
              d.getPosition(l.endContainer) & CKEDITOR.POSITION_CONTAINS ||
        ...
        g.attachListener(
          ...
          function() {
            v &&
              CKEDITOR.env.webkit &&
              (v =
                e._.previousActive && e._.previousActive.equals(f.getActive()));
            e.unlockSelection(v);
            v = 0;
          },
          null,
          ...
          g.attachListener(g, "mousedown", function(a) {
            2 == a.data.$.button &&
              (((a = e.document.getSelection()) &&
                ...
                (I = e.window.getScrollPosition()));
          });
          g.attachListener(g, "mouseup", function(a) {
            2 == a.data.$.button &&
              I &&
              ((e.document.$.documentElement.scrollLeft = I.x),
              (e.document.$.documentElement.scrollTop = I.y));
            I = null;
          });
              ...
              k.on("mousedown", function(a) {
                function b(a) {
                  ...
                  if (d) {
                    ...
                    d.setEndPoint(
                      0 > f.compareEndPoints("StartToStart", c)
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
                  ...
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var f = c.item(e),
                        ...
                        g = 0,
                        a = new CKEDITOR.dom.range(this.root);
                      g < h.childNodes.length && h.childNodes[g] != f;
                      g++
                    );
          ...
          if (this.isLocked) {
            ...
            if (k) this.fake(k);
              ...
              if (q) {
                ...
                if (
                  (k.startContainer.type == CKEDITOR.NODE_ELEMENT &&
                    k.startContainer.getName() in b) ||
                  (k.endContainer.type == CKEDITOR.NODE_ELEMENT &&
                    k.endContainer.getName() in b)
                )
                  k.shrink(CKEDITOR.NODE_ELEMENT, !0), (a = k.collapsed);
                x = k.createBookmark();
                b = x.startNode;
                a || (f = x.endNode);
                ...
                f
                  ? ((n = k.document.$.body.createTextRange()),
                    n.moveToElementText(f.$),
                    x.setEndPoint("EndToEnd", n),
                    x.moveEnd("character", -1))
                  : ((u = b.getNext(w)),
                    (t = b.hasAscendant("pre")),
                    (u =
                      !(u && u.getText && u.getText().match(n)) &&
                      (t ||
                        !b.hasPrevious() ||
                        (b.getPrevious().is && b.getPrevious().is("br")))),
                    (t = k.document.createElement("span")),
                    t.setHtml("\x26#65279;"),
                    t.insertBefore(b),
                    u && k.document.createText("﻿").insertBefore(b));
                k.setStartBefore(b);
                b.remove();
                a
                  ? (u
                      ? (x.moveStart("character", -1),
                        x.select(),
                        k.document.$.selection.clear())
                      : x.select(),
                    k.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START),
                    t.remove())
                  : (k.setEndBefore(f), f.remove(), x.select());
              } else {
                f = this.getNative();
                if (!f) return;
                ...
                for (x = 0; x < a.length; x++) {
                  ...
                  k.collapsed &&
                    ...
                    "br" == u.getName()
                      ...
                      : k.moveToPosition(n, CKEDITOR.POSITION_AFTER_END));
                  t.setStart(k.startContainer.$, k.startOffset);
                  try {
                    t.setEnd(k.endContainer.$, k.endOffset);
                  } catch (D) {
                    if (0 <= D.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                      k.collapse(1), t.setEnd(k.endContainer.$, k.endOffset);
                    else throw D;
                  }
                  f.addRange(t);
                }
  ...
  (function() {
          ...
          if (r.equals(w)) (r = null), (k = !0);
            ...
            if (x && m && CKEDITOR.dtd.$block[t])
              for (
                var A = r,
                  ...
                  G = z.length,
                  H = 0,
                  A = G && new CKEDITOR.dom.range(A.getDocument());
                H < G;
                ++H
              ) {
                var C = z[H],
                ...
                if (R ? R.check(this) : 1)
                  A.selectNodeContents(C), b.call(this, A);
              }
            ...
            if (z)
              if (
                ...
                (H = l),
                !C ||
                  (!(C.getDtd() || CKEDITOR.dtd.span)[G] && !H) ||
                  (z.parentRule && !z.parentRule(C)))
              )
                k = !0;
              else {
                if (
                  (u ||
                    (t &&
                      CKEDITOR.dtd.$removeEmpty[t] &&
                      (r.getPosition(w) | M) != M) ||
                    ((u = c.clone()), u.setStartBefore(r)),
                  (t = r.type),
                  t == CKEDITOR.NODE_TEXT ||
                    x ||
                    (t == CKEDITOR.NODE_ELEMENT && !r.getChildCount()))
                ) {
                  for (
                    var t = r, Y;
                    (k = !t.getNext(K)) &&
                    ((Y = t.getParent()), n[Y.getName()]) &&
                    d(Y, q, h, Q);
    ...
    function u(a, b) {
      ...
      for (var k in c)
        (this._.definition.fullMatch && a.getStyle(k) != p(k, c[k], !0)) ||
          ((f = f || !!a.getStyle(k)), a.removeStyle(k));
      q(a, e, C[a.getName()]);
      f &&
    ...
    function B(a) {
      for (
        var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count();
        0 <= --e;
      ...
      for (var f in b)
        if (f != this.element)
          for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)
            (d = c.getItem(e)), d.isReadOnly() || q(d, b[f]);
    }
    function q(a, b, c) {
      if ((b = b && b.attributes))
              ...
              if ("_length" != h) {
                ...
                if ("style" == h)
                  a: {
                    ...
                    "string" == typeof e &&
                      (e = CKEDITOR.tools.parseCssText(e, !0));
                    g = void 0;
                    for (g in d)
                      if (
                        !(g in e) ||
                        (e[g] != d[g] && "inherit" != d[g] && "inherit" != e[g])
                      ) {
                        d = !1;
                        break a;
                      }
    ...
    attachStyleStateChange: function(a, d) {
      ...
      b ||
        ...
        this.on("selectionChange", function(a) {
          for (var d = 0; d < b.length; d++) {
            var g = b[d],
              l = g.style.checkActive(a.data.path, this)
...
*/
      ...
      if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
        var f = a.getParentEditor(),
          ...
          n = CKEDITOR.tools.addFunction(function(e) {
            ...
            d.$.getElementsByTagName("iframe").length &&
            ...
            CKEDITOR.env.ie6Compat &&
              ((d = u.getChild(0).getFrameDocument()),
              d.on("mousemove", b),
              d.on("mouseup", c));
        ...
        for (var c in b.contents)
          if (b.contents[c]) {
            ...
            if (d) {
              ...
              !f || (e && !this._.editor.activeFilter.check(e))
  ...
  (function() {
    ...
    function y(b) {
      ...
      function l(a, d) {
        ...
        if (!c.getById("cke_pastebin")) {
          ...
          CKEDITOR.env.webkit
            ...
            : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(m);
          m.setStyles({
            position: "absolute",
          ...
          setTimeout(function() {
            CKEDITOR.env.webkit &&
              (CKEDITOR.document.getBody().$.scrollTop = l);
            q && q.removeListener();
      ...
      function k(a) {
        ...
        c && n.canClipboardApiBeTrusted(d.dataTransfer, b)
          ? (a.data.preventDefault(),
            setTimeout(function() {
              r(b, d);
            }, 0))
          : l(a, function(a) {
              d.dataValue = a.replace(
        ...
        get: function(c) {
          return "plain-text" == c
            ...
            ? ((c = a.semanticContent) ||
                ...
                c.allow({
                  $1: { elements: b(), attributes: !0, styles: !1, classes: !1 }
                }),
          ...
          function(e) {
            if ((e = e.data)) {
              ...
              h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL
                ...
                : h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS
                ? c(g, f, h)
                : d(f, h);
            }
          },
      ...
      init: function(b) {
        ...
        b.on(
          ...
          function(a) {
            ...
            "text" == e && "html" == f
              ? (g = x(b, g, c.get("plain-text")))
              : l == CKEDITOR.DATA_TRANSFER_EXTERNAL &&
                b.pasteFilter &&
                !a.dontFilter &&
                (g = x(b, g, b.pasteFilter));
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      fixSplitNodesAfterDrop: function(b, a, c, d) {
        ...
        "number" == typeof d &&
          ...
          (e(b.startContainer, g, c) || e(b.endContainer, g, d));
      },
      ...
      getRangeAtDropPosition: function(b, a) {
        ...
        if (document.caretRangeFromPoint)
          (c = a.document.$.caretRangeFromPoint(d, e)),
              ...
              var a = CKEDITOR.tools.bind(function() {
                ...
                if (p.autoSize) {
                  var b = p.element.getDocument(),
                    b = (CKEDITOR.env.webkit ? p.element : b.getBody()).$
                      .scrollWidth;
                  CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks &&
                    0 < b &&
  ...
  CKEDITOR.plugins.add("menu", {
    ...
    beforeInit: function(g) {
      for (
        var h = g.config.menu_groups.split(","),
          p = (g._.menuGroups = {}),
          n = (g._.menuItems = {}),
          a = 0;
        a < h.length;
  ...
  (function() {
    ...
    CKEDITOR.env.gecko &&
      (h += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;"');
    var h =
        h +
      ...
      proto: {
        ...
        show: function(a, b, c, m) {
          ...
          var e = this.items,
            ...
            f = this._.element;
          if (!k) {
            k = this._.panel = new CKEDITOR.ui.floatPanel(
              this.editor,
          ...
          CKEDITOR.ui.fire("ready", this);
          this.parent
            ? this.parent._.panel.showAsChild(k, this.id, a, b, c, m)
            : k.showBlock(this.id, a, b, c, m);
          l.fire("menuShow", [k]);
        },
      ...
      proto: {
        render: function(a, b, c) {
          ...
          this.role in { menuitemcheckbox: 1, menuitemradio: 1 } &&
            (l =
              ' aria-checked\x3d"' +
              (e == CKEDITOR.TRISTATE_ON ? "true" : "false") +
              '"');
          var f = this.getItems,
            d =
      ...
      render: function(a, b) {
        ...
        if (this.modes) {
          ...
          g &&
            ...
            (f +=
              g.state == CKEDITOR.TRISTATE_ON
                ? "on"
                : g.state == CKEDITOR.TRISTATE_DISABLED
                ? "disabled"
                : "off"));
        if (this.directional)
          a.on(
  ...
  (function() {
    function B(a) {
      function d() {
        for (
          var b = g(),
            e = CKEDITOR.tools.clone(a.config.toolbarGroups) || q(a),
            f = 0;
          f < e.length;
          f++
        ) {
      ...
      init: function(a) {
        ...
        a.on("uiSpace", function(c) {
          if (c.data.space == a.config.toolbarLocation) {
            ...
            for (
              var r = a.toolbox.toolbars, f = B(a), l = 0;
              l < f.length;
              l++
            ) {
              var m,
                      ...
                      if (t.type == CKEDITOR.UI_SEPARATOR) k = e && t;
                        ...
                        if (!n) {
                          ...
                          b.push(
                            ...
                            v ? ' aria-labelledby\x3d"' + m + '_label"' : "",
                          ...
                          var u = r.push(n) - 1;
                          0 < u &&
                            ((n.previous = r[u - 1]), (n.previous.next = n));
                        }
                        q
                          ? e ||
                            (b.push(
            ...
            if (
              ...
              b.push(
                '" onclick\x3d"CKEDITOR.tools.callFunction(' + A + ')"\x3e',
      ...
      a.on("selectionChange", function() {
        for (
          ...
          f = h.data("cke-display-name")
            ...
            ? h.data("cke-real-element-type")
            : h.getName();
          (d = h.hasAttribute("contenteditable")
      ...
      a.contextMenu &&
        ...
        (a.contextMenu.addListener(function(b, d) {
          var e = a.scayt,
            ...
            l;
          e &&
            (l = e.getSelectionNode()) &&
            ((k = c.menuGenerator(a, l)),
            e.showBanner(
              "." +
      ...
      a.on("readOnly", function(b) {
        ...
        b &&
          ...
          !0 === b.editor.readOnly
            ...
            : d
            ? d.fire("startSpellCheck, startGrammarCheck")
        ...
        "function" !== typeof window.SCAYT.CKSCAYT
          ? ((this.loadingHelper[a.name] = c),
            ...
            this.loadingHelper.ckscaytLoading ||
              (CKEDITOR.scriptLoader.load(e, function(a) {
                if (a) {
