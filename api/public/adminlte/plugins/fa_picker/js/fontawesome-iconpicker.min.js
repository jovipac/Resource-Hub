  ...
  (a.pos = {
    ...
    (a.fn.pos = function(b) {
      ...
      return (
        ...
        "right" === b.at[0]
          ? (r.left += n)
          : "center" === b.at[0] && (r.left += n / 2),
        "bottom" === b.at[1]
          ? (r.top += p)
          : "center" === b.at[1] && (r.top += p / 2),
        (f = c(x.at, n, p)),
        (r.left += f[0]),
        (r.top += f[1]),
        this.each(function() {
          ...
          "right" === b.my[0]
            ? (A.left -= l)
            : "center" === b.my[0] && (A.left -= l / 2),
            "bottom" === b.my[1]
              ? (A.top -= m)
              : "center" === b.my[1] && (A.top -= m / 2),
            (A.left += B[0]),
            (A.top += B[1]),
            a.support.offsetFractions ||
              ((A.left = i(A.left)), (A.top = i(A.top))),
            (e = { marginLeft: o, marginTop: s }),
            ...
            b.using &&
              (j = function(a) {
                ...
                n < l && h(c + d) < n && (i.horizontal = "center"),
                  p < m && h(e + f) < p && (i.vertical = "middle"),
                  g(h(c), h(d)) > g(h(e), h(f))
        ...
        left: function(b, c) {
          ...
          c.collisionWidth > h
            ? j > 0 && k <= 0
              ...
              ? (b.left = f)
              : j > k
              ? (b.left = f + h - c.collisionWidth)
              : (b.left = f)
            : j > 0
            ? (b.left += j)
            : k > 0
            ? (b.left -= k)
            : (b.left = g(b.left - i, b.left)),
        ...
        top: function(b, c) {
          ...
          c.collisionHeight > h
            ? j > 0 && k <= 0
              ...
              ? (b.top = f)
              : j > k
              ? (b.top = f + h - c.collisionHeight)
              : (b.top = f)
            : j > 0
            ? (b.top += j)
            : k > 0
            ? (b.top -= k)
            : (b.top = g(b.top - i, b.top)),
      ...
      flip: {
        ...
        top: function(b, c) {
          ...
          var d,
            ...
            q = -2 * c.offset[1];
          l < 0
            ? ((e = b.top + o + p + q + c.collisionHeight - i - g),
              b.top + o + p + q > l &&
                (e < 0 || e < h(l)) &&
                (b.top += o + p + q))
            : m > 0 &&
    ...
    var b = {
      ...
      c = function(d, e) {
        (this._id = c._idCounter++),
          ...
          this.isDropdownMenu() &&
            ((this.options.templates.search = !1),
            (this.options.templates.buttons = !1),
    ...
    (c._idCounter = 0),
      ...
      (c.prototype = {
        ...
        _createPopover: function() {
          ...
          return (
            this.options.animation === !0 && this.popover.addClass("fade"),
            this.popover
          );
        },
        _createIconpicker: function() {
          ...
          for (var d in this.options.icons) {
            ...
            e
              .find("i")
              .addClass(this.options.fullClassFormatter(this.options.icons[d])),
              e
                .data("iconpickerValue", this.options.icons[d])
            ...
            this.hasInput() &&
              this.input.on("keyup.iconpicker", function(d) {
                b.inArray(d.keyCode, [
                  ...
                  ? c._updateFormGroupStatus(c.getValid(this.value) !== !1)
                  : c.update(),
                  c.options.inputSearch === !0 &&
                    c.filter(
                      a(this)
                        .val()
                        .toLowerCase()
        ...
        getValid: function(c) {
          ...
          var d = "" === c;
          return (
            (c = a.trim(c)), !(!b.inArray(c, this.options.icons) && !d) && c
          );
        },
        setValue: function(a) {
          ...
          return (
            ...
            b === !0
              ...
              : ((a = this.setSourceValue(a)),
                this._updateFormGroupStatus(a !== !1)),
