...
(function($) {
  if ($.fn.inputmask === undefined) {
    ...
    var msie10 = navigator.userAgent.match(new RegExp("msie 10", "i")) !== null,
      ...
      android =
        navigator.userAgent.match(new RegExp("android.*safari.*", "i")) !==
        null,
      androidchrome =
        navigator.userAgent.match(new RegExp("android.*chrome.*", "i")) !==
        null,
      ...
      function HandleRemove(input, k, pos) {
        ...
        if (pos.begin == pos.end) {
          ...
          if (
            ...
            pos.begin =
              getActiveBuffer().length - 1 ==
              posBegin /* radixPoint is latest? delete it */
                ? pos.begin
                : k == opts.keyCode.BACKSPACE
                ? posBegin
                : seekNext(posBegin);
