...
(function() {
  ...
  var t = this,
    ...
    e = function(t) {
      ...
      (this.width = i(t.canvas, "Width") || t.canvas.width),
        (this.height = i(t.canvas, "Height") || t.canvas.height);
      return (
  ...
  var s = (e.helpers = {}),
    ...
    y =
      ((s.calculateScaleRange = function(t, i, e, s, o) {
        var a = 2,
        ...
        var c = m(r),
          u = g(r);
        u === c && ((u += 0.5), c >= 0.5 && !s ? (c -= 0.5) : (u += 0.5));
        for (
          var d = Math.abs(u - c),
            p = x(d),
            f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p),
            v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p),
            S = f - v,
            C = Math.pow(10, p),
            y = Math.round(S / C);
          (y > h || h > 2 * y) && !l;
        ...
        return (
          l && ((y = a), (C = S / y)),
          { steps: y, stepValue: C, min: v, max: v + y * C }
        );
      }),
    ...
    R = (s.getStyle = function(t, i) {
      return t.currentStyle
        ? t.currentStyle[i]
        : document.defaultView.getComputedStyle(t, null).getPropertyValue(i);
    }),
    T =
  ...
  (e.instances = {}),
              ...
              var c = [],
                ...
                d = function(t) {
                  ...
                  return (
                    ...
                    (o = m(r)),
                    (e = g(r)),
                    { x: o > this.chart.width / 2 ? o : e, y: (a + n) / 2 }
                  );
                }.call(this, h);
              new e.MultiTooltip({
                x: d.x,
      ...
      buildYLabels: function() {
        ...
        this.yLabelWidth =
          this.display && this.showLabels
            ? z(this.ctx, this.font, this.yLabels) + 10
            : 0;
      },
      ...
      fit: function() {
        ...
        for (
          ...
          (e = this.endPoint - this.startPoint),
            ...
            this.buildYLabels(),
            t < this.yLabelWidth &&
              ((this.endPoint = i), this.calculateXLabelRotation());
      },
      calculateXLabelRotation: function() {
        ...
        if (
          ...
          (this.xScalePaddingLeft =
            e / 2 > this.yLabelWidth ? e / 2 : this.yLabelWidth),
          ...
          for (
            ...
            (n = Math.cos(S(this.xLabelRotation))),
              (t = n * e),
              (i = n * s),
              t + this.fontSize / 2 > this.yLabelWidth &&
            ...
            for (var i = this.valuesCount - 1; i >= 0; i--) {
              ...
              if (
                (this.angleLineWidth > 0 &&
                  ...
                  ((e = this.calculateCenterOffset(this.max)),
    ...
    (e.animationService = {
      ...
      addAnimation: function(t, i) {
        ...
        this.animations.push({ chartInstance: t, animationObject: i }),
          1 == this.animations.length &&
            s.requestAnimFrame.call(window, this.digestWrapper);
      },
      ...
      startDigest: function() {
        var t = Date.now(),
          i = 0;
        this.dropFrames > 1 &&
          ((i = Math.floor(this.dropFrames)), (this.dropFrames -= i));
        for (var e = 0; e < this.animations.length; e++)
          null === this.animations[e].animationObject.currentStep &&
            (this.animations[e].animationObject.currentStep = 0),
            (this.animations[e].animationObject.currentStep += 1 + i),
            this.animations[e].animationObject.currentStep >
              this.animations[e].animationObject.numSteps &&
              (this.animations[e].animationObject.currentStep = this.animations[
                e
              ].animationObject.numSteps),
            this.animations[e].animationObject.render(
              this.animations[e].chartInstance,
              this.animations[e].animationObject
            ),
            this.animations[e].animationObject.currentStep ==
              this.animations[e].animationObject.numSteps &&
              (this.animations[e].animationObject.onAnimationComplete.call(
                this.animations[e].chartInstance
              ),
                  ...
                  function(e, s) {
                    n.bars.push(
                      new this.BarClass({
                        ...
                        strokeColor:
                          "object" == typeof i.strokeColor
                            ? i.strokeColor[s]
                            : i.strokeColor,
                        fillColor:
                          "object" == typeof i.fillColor
                            ? i.fillColor[s]
                            : i.fillColor,
                        highlightFill: i.highlightFill
                          ? "object" == typeof i.highlightFill
                            ? i.highlightFill[s]
                            : i.highlightFill
                          : "object" == typeof i.fillColor
                          ? i.fillColor[s]
                          : i.fillColor,
                        highlightStroke: i.highlightStroke
                          ? "object" == typeof i.highlightStroke
                            ? i.highlightStroke[s]
                            : i.highlightStroke
                          : "object" == typeof i.strokeColor
                          ? i.strokeColor[s]
    ...
    i.Type.extend({
      ...
      initialize: function(t) {
        (this.segments = []),
          ...
          e.each(
            ...
            function(i, e) {
              i.color ||
                (i.color = "hsl(" + (360 * e) / t.length + ", 100%, 50%)"),
                this.addData(i, e, !0);
            },
            this
          ),
      ...
      addData: function(t, e, s) {
        ...
        "undefined" == typeof t.color &&
          ((t.color =
            i.defaults.global.segmentColorDefault[
              n % i.defaults.global.segmentColorDefault.length
            ]),
          (t.highlight =
            i.defaults.global.segmentHighlightColorDefaults[
              n % i.defaults.global.segmentHighlightColorDefaults.length
            ])),
