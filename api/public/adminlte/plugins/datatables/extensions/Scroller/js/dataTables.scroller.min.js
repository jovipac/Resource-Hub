...
(function(m, n, k) {
    ...
    g.prototype = {
      ...
      _fnCalcRowHeight: function() {
        ...
        a._bInitComplete
          ? (a = b.parentNode)
          : (this.s.dt.nHolding ||
              (this.s.dt.nHolding = e("<div></div>").insertBefore(
                this.s.dt.nTable
              )),
          ...
          var a = this.s.dt,
            ...
            g =
              ...
              a.fnRecordsDisplay() == a.fnRecordsTotal()
                ...
                ? b.sInfoEmpty +
                  " " +
                  b.sInfoFiltered.replace("_MAX_", i) +
                  b.sInfoPostFix
                : a.fnRecordsDisplay() == a.fnRecordsTotal()
                ? b.sInfo
                    .replace("_START_", g)
  ...
  "function" === typeof define && define.amd
    ...
    : jQuery && !jQuery.fn.dataTable.Scroller && l(jQuery, jQuery.fn.dataTable);
})(window, document);
