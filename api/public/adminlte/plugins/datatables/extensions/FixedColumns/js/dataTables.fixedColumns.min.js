...
(function(r, s, t) {
    ...
    j.prototype = {
      ...
      _fnConstruct: function(a) {
        ...
        if (
          ...
          var g =
            "onwheel" in s.createElement("div")
              ? "wheel.DTFC"
              : "mousewheel.DTFC";
      ...
      _fnGridLayout: function() {
        ...
        0 < this.s.iLeftColumns &&
          ((a.left.wrapper.style.width = e + "px"),
        ...
        for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
          ...
          for (var k = 0, j = this.s.iTableColumns; k < j; k++)
            if (-1 !== d.inArray(k, b)) {
              ...
              -1 === m
                ? ((m = d(a[e][k].cell).clone(!0, !0)[0]),
                  g.push(m),
                  f.push(a[e][k].cell),
                  i.push({ cell: m, unique: a[e][k].unique }))
      ...
      _fnClone: function(a, b, c, g) {
        ...
        if (g) {
          ...
          for (h = n.length; e < h; e++) {
            ...
            for (k = n[e].length; i < k; i++)
              (q[e][i].cell.className = n[e][i].cell.className),
                d("span.DataTables_sort_icon", q[e][i].cell).each(function() {
                  this.className = d(
        ...
        null !== a.body &&
          (a.body.parentNode.removeChild(a.body), (a.body = null));
        ...
        if (0 < l.aiDisplay.length) {
          ...
          for (o = 0; o < c.length; o++)
            (j = c[o]),
              (m = d(l.aoColumns[j].nTh).clone(!0)[0]),
              (m.innerHTML = ""),
              (k = m.style),
              (k.paddingTop = "0"),
              (k.paddingBottom = "0"),
              ...
              (k.height = 0),
              (k.width = f.s.aiInnerWidths[j] + "px"),
              h.appendChild(m);
        ...
        null !== f.s.dt.nTFoot &&
          ((b = l.oApi._fnGetUniqueThs(l, d(">tfoot", a.footer)[0])),
          d(b).each(function(a) {
            j = c[a];
            this.style.width = f.s.aiInnerWidths[j] + "px";
          }));
      ...
      _fnEqualiseHeights: function(a, b, c) {
        if (
          !("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)
        ) {
          var g,
            f,
          ...
          for (
            ...
            (g = e[c].offsetHeight),
              (f = b[c].offsetHeight),
              (g = f > g ? f : g),
              "semiauto" == this.s.sHeightMatch && (e[c]._DTTC_iHeight = g),
              h.push(g);
          c = 0;
          for (a = b.length; c < a; c++)
            (b[c].style.height = h[c] + "px"),
              (e[c].style.height = h[c] + "px");
        }
      }
    };
    j.defaults = {
  ...
  "function" === typeof define && define.amd
    ...
    : jQuery &&
      !jQuery.fn.dataTable.FixedColumns &&
