  ...
  o = function(d) {
    d.fn.dataTableExt.oApi.fnColReorder = function(a, b, e) {
      ...
      if (b != e)
        if (0 > b || b >= n)
          ...
          for (g = n; c < g; c++)
            (j = a.aoColumns[c]),
              "number" == typeof j.mData
                ? ((j.mData = k[j.mData]), a.oApi._fnColumnOptions(a, c, {}))
                : d.isPlainObject(j.mData) &&
                  (i(j.mData, "_", k),
                  i(j.mData, "filter", k),
                  i(j.mData, "sort", k),
                  i(j.mData, "type", k),
          ...
          for (g = a.aoData.length; c < g; c++)
            (i = a.aoData[c]),
              h
                ? (i.anCells && l(i.anCells, b, e),
                  "dom" !== i.src && d.isArray(i._aData) && l(i._aData, b, e))
                : (d.isArray(i._aData) && l(i._aData, b, e),
                  l(i._anHidden, b, e));
          c = 0;
    ...
    var f = function(a, b) {
      ...
      d.fn.dataTable.Api
        ...
        ? (e = a.fnSettings())
        : "string" === typeof a
        ? d.fn.dataTable.fnIsDataTable(d(a)[0]) &&
          (e = d(a)
            .eq(0)
            .dataTable()
            .fnSettings())
        : a.nodeName && "table" === a.nodeName.toLowerCase()
        ? d.fn.dataTable.fnIsDataTable(a.nodeName) &&
          (e = d(a.nodeName)
            .dataTable()
            .fnSettings())
        : a instanceof jQuery
        ? d.fn.dataTable.fnIsDataTable(a[0]) &&
          (e = a
            .eq(0)
            .dataTable()
            .fnSettings())
    ...
    f.prototype = {
      ...
      _fnConstruct: function() {
        ...
        if (d)
          if (a.s.dt._bInitComplete) (b = p(d)), a._fnOrderColumns.call(a, b);
          else {
            var c = !1;
      ...
      _fnStateSave: function(a) {
        ...
        if (a.aaSorting) {
          ...
          for (e = c.length; b < e; b++)
            (h = c[b]._ColReorder_iOrigCol),
              (a.aoSearchCols[h] = f[b]),
              (a.abVisCols[h] = c[b].bVisible),
              a.ColReorder.push(h);
        } else if (a.order) {
      ...
      _fnMouseDown: function(a, b) {
        ...
        c !== s &&
          ...
          (this.s.mouse.offsetX = a.pageX - f.left),
          (this.s.mouse.offsetY = a.pageY - f.top),
      ...
      _fnCreateDragNode: function() {
        var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY,
          ...
          c = f.parentNode,
          g = d(b).clone();
        this.dom.drag = d(c.cloneNode(!1))
          .addClass("DTCR_clonedTable")
          .append(d(f.cloneNode(!1)).append(d(e.cloneNode(!1)).append(g[0])))
          .css({
            position: "absolute",
            top: 0,
            left: 0,
    ...
    d.fn.dataTableExt.fnVersionCheck("1.9.3")
      ? d.fn.dataTableExt.aoFeatures.push({
          fnInit: function(a) {
            ...
            a._colReorder
              ...
              : ((b = a.oInit), new f(a, b.colReorder || b.oColReorder || {}));
            return null;
          },
          cFeature: "R",
          sFeature: "ColReorder"
