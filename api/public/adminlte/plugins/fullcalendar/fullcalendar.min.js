...
(function(t) {
  ...
  function y(t, e) {
    ...
    return l > a && u > o
      ? (o >= a ? ((n = o.clone()), (r = !0)) : ((n = a.clone()), (r = !1)),
        u >= l ? ((i = l.clone()), (s = !0)) : ((i = u.clone()), (s = !1)),
  ...
  function me(n, r) {
    ...
    function a() {
      (oe = te.theme ? "ui" : "fc"),
        ...
        te.handleWindowResize &&
          ((ue = G(E, te.windowResizeDelay)), t(window).resize(ue));
    }
    function u() {
      le && le.destroyView(),
        ie.destroy(),
    ...
    function h(e, n) {
      pe++,
        le &&
          n &&
          le.type !== n &&
          (ie.deactivateButton(le.type),
          j(),
          le.start && le.destroyView(),
          le.el.remove(),
          (le = null)),
        !le &&
          n &&
          ((le = f(n)),
          (le.el = t("<div class='fc-view fc-" + n + "-view' />").appendTo(se)),
          ie.activateButton(n)),
        le &&
          (0 > e
            ? (de = le.computePrevDate(de))
            : e > 0 && (de = le.computeNextDate(de)),
          (le.start && !e && de.isWithin(le.intervalStart, le.intervalEnd)) ||
            (d() &&
              (j(),
              le.start && le.destroyView(),
              le.setDate(de),
    ...
    function w() {
      ae =
        "number" == typeof te.contentHeight
          ? te.contentHeight
          : "number" == typeof te.height
          ? te.height - (re ? re.outerHeight(!0) : 0)
          : Math.round(se.width() / Math.max(te.aspectRatio, 0.5));
    }
    function E(t) {
      !pe &&
        t.target === window &&
    ...
    function z() {
      var t = Q.getNow();
      t.isWithin(le.intervalStart, le.intervalEnd)
        ? ie.disableButton("today")
        : ie.enableButton("today");
    }
    function L(t, e) {
      (t = Q.moment(t)),
        (e = e
    ...
    function I(t, e) {
      ...
      (e && p(e)) ||
        ((e = e || "day"),
        (n = ie.getViewsWithButtons().join(" ")),
        (i = n.match(RegExp("\\w+" + P(e)))),
        i || (i = n.match(/\w+Day/)),
        (e = i ? i[0] : "agendaDay")),
        (de = t),
        c(e);
    ...
    function K(t, e) {
      return te[t]
        ? te[t].apply(e || fe, Array.prototype.slice.call(arguments, 2))
        : void 0;
    }
    var Q = this;
    r = r || {};
    ...
    (Q.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration)),
      ...
      (Q.moment = function() {
        ...
        return (
          "local" === te.timezone
            ? ((t = De.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
                "UTC" === te.timezone
                ...
                : (e[r]
                  ...
                  l &&
                    ...
                    (v = t(
                      ...
                      .click(function() {
                        v.hasClass(f + "-state-disabled") ||
                          (l(),
                          (v.hasClass(f + "-state-active") ||
                            v.hasClass(f + "-state-disabled")) &&
                            v.removeClass(f + "-state-hover"));
                      })
                      .mousedown(function() {
                      ...
                      .hover(
                        ...
                        function() {
                          v.removeClass(f + "-state-hover").removeClass(
                            f + "-state-down"
                          );
                        }
                      )),
  ...
  function ye(n) {
        ...
        if (n == U) {
          if (i)
            for (r = 0; i.length > r; r++)
              (s = i[r]), (o = l ? s : b(s, e)), o && Q.push.apply(Q, H(o));
          q--, q || j(Q);
        }
      });
    }
    function o(e, i) {
      ...
      for (r = 0; l.length > r; r++) {
        if (
          ((s = l[r].call(O, e, B.clone(), Z.clone(), n.timezone, i)), s === !0)
        )
          return;
      ...
      null == t.allDay &&
        ...
        t.allDay
          ...
          : (t.start.hasTime() || (t.start = O.rezoneDate(t.start)),
            t.end && !t.end.hasTime() && (t.end = O.rezoneDate(t.end))),
    ...
    function x(t) {
      ...
      return (
        t.end ||
          ...
          (t = { start: t.start, end: O.getDefaultEventEnd(e, t.start) })),
        t
      );
    }
    function H(e, n, i) {
      ...
      return (
        ...
        !i &&
          ...
          (s = E(n.end, n.start).subtract(
            E(e._end || O.getDefaultEventEnd(e._allDay, e._start), e._start)
          )),
      ...
      return (
        ...
        t.each(e, function(e, u) {
          ...
          (d = {
            ...
            s &&
              (c.end || (c.end = O.getDefaultEventEnd(c.allDay, c.start)),
              c.end.add(s)),
            l &&
              !c.allDay &&
              (r || s) &&
    ...
    function G(t, e, n, i) {
      ...
      for (o = 0; Q.length > o; o++)
        if (((l = Q[o]), (!i || i._id !== l._id) && Y(l, t))) {
          ...
          if (i) {
            if (((a = F(l.overlap, (l.source || {}).overlap)), a === !1))
              return !1;
    ...
    var B,
      ...
      K = 0,
      Q = [];
    t.each((n.events ? [n.events] : []).concat(n.eventSources || []), function(
      t,
      e
    ) {
      var n = a(e);
    ...
    return (
      this.each(function(r, s) {
        ...
        "string" == typeof e
          ...
          : a || ((a = new me(l, e)), l.data("fullCalendar", a), a.render());
      }),
      i
    );
  };
      ...
      position: function() {
        ...
        (r = o.top || 0),
          ...
          o.viewportConstrain !== !1 &&
            ((r = Math.min(r, e + c.outerHeight() - u - this.margin)),
    ...
    Be = K.extend({
      ...
      getCell: function(t, e) {
        ...
        if (this.inBounds(t, e)) {
          ...
          if (null !== l && null !== a)
            return (r = this.grid.getCell(l, a)), (r.grid = this.grid), r;
        }
        return null;
      },
        ...
        d = new Ie(r.coordMap, {
          ...
          cellOver: function(e, s) {
            ...
            (n = i.computeEventDrop(u, e, o)),
              n
                ? (r.renderDrag(n, t) ? l.hide() : l.show(), s && (n = null))
                : (l.show(), a());
          },
          cellOut: function() {
        ...
        cellOver: function(e) {
          (i = e.end),
            ...
            i.isSame(f)
              ...
              ? (s.renderEventResize({ start: h, end: i }, t), o.hideEvent(c))
              : ((i = null), a());
        },
        cellOut: function() {
          (i = null), n();
      ...
      return (
        t.each(i, function(t, e) {
          e.length &&
            r.push.apply(
              r,
              te(e[0]) ? n.eventsToInverseRanges(e) : n.eventsToNormalRanges(e)
            );
        }),
        r
      );
      ...
      for (
        ...
        (r = i * f),
          ...
          u >= a &&
            ...
            c
              ? ((d.leftCol = f - u - 1), (d.rightCol = f - a - 1))
    ...
    fgSegHtml: function(t, e) {
      ...
      return (
        ...
        !r.allDay &&
          t.isStart &&
          (u =
            '<span class="fc-time">' + z(this.getEventTimeText(r)) + "</span>"),
        (n =
          '<span class="fc-title">' +
          (z(r.title || "") || "&nbsp;") +
          "</span>"),
        ...
        if (
          ...
          for (a = 0; s.length > a; a++) {
            for (
              u = s[a],
                i(u.leftCol),
                d = t('<td class="fc-event-container"/>').append(u.el),
      ...
      limitRow: function(e, n) {
        ...
        if (n && S.segLevels.length > n) {
          for (
            ...
            for (u = s[a], i(u.leftCol), h = [], c = 0; u.rightCol >= D; )
              (r = this.getCell(e, D)),
          ...
          .on("click", function(s) {
            ...
            "function" == typeof o &&
              (o = r.trigger(
                "eventLimitClick",
                null,
                { date: l, dayEl: u, moreEl: a, segs: c, hiddenSegs: h },
                s
              )),
              "popover" === o
      ...
      for (
        ...
        (t = this.start.clone().time(a)),
          ...
          (i =
            ...
            (l && n
              ? ""
              : "<span>" + z(t.format(this.axisFormat)) + "</span>") +
            "</td>"),
          (o +=
            "<tr " +
            (n ? 'class="fc-minor"' : "") +
      ...
      if (n.length) {
        for (
          ...
          if (((a = r[l]), (u = t("<td/>").appendTo(o)), a.length))
            for (
              d = t('<div class="fc-' + i + '-container"/>').appendTo(u),
  ...
  Ue.mixin({
    ...
    renderSegTable: function(e) {
      ...
      for (
        ...
        for (
          o = n[s], ae(o), l = t('<div class="fc-event-container"/>'), i = 0;
          o.length > i;
          i++
        )
          (r = o[i]),
  ...
  var tn = (Ce.month = Je.extend({
    computeRange: function(t) {
      ...
      return (
        this.isFixedWeeks() &&
          e.end.add(6 - e.end.diff(e.start, "weeks"), "weeks"),
        e
      );
    },
    setGridHeight: function(t, e) {
