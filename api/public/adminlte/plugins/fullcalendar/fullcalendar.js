  ...
  var Grid = (fc.Grid = RowRenderer.extend({
    ...
    setRange: function(range) {
      ...
      this.eventTimeFormat =
        view.opt("timeFormat") || this.computeEventTimeFormat();
      ...
      dragListener = new DragListener(this.coordMap, {
        ...
        cellOver: function(cell) {
          ...
          if (newEnd.isSame(oldEnd)) {
            ...
            !calendar.isEventRangeAllowed({ start: start, end: newEnd }, event)
          ) {
            newEnd = null;
            disableCursor();
          } else {
...
----------------------------------------------------------------------------------------------------------------------*/
  ...
  DayGrid.mixin({
    ...
    resliceDaySegs: function(segs, dayDate) {
      ...
      return this.eventsToSegs(events, function(range) {
  ...
  function Calendar(element, instanceOptions) {
    ...
    function zoomTo(newDate, viewType) {
      ...
      if (!viewType || !isValidViewType(viewType)) {
        ...
        match = viewStr.match(
          new RegExp("\\w+" + capitaliseFirstLetter(viewType))
        );
      ...
      for (i = 0; i < cache.length; i++) {
        ...
        if (eventIntersectsRange(otherEvent, range)) {
          ...
          if (event) {
            ...
            if (
              typeof otherOverlap === "function" &&
              !otherOverlap(event, otherEvent)
            ) {
              return false;
            }
          }
      ...
      if (this.weekNumbersVisible) {
        return (
          ...
          this.calendar.calculateWeekNumber(
            this.dayGrid.getCell(row, 0).start
          ) +
          "</span>" +
          "</td>"
        );
  ...
  var MonthView = (fcViews.month = BasicView.extend({
    ...
    computeRange: function(date) {
      ...
      if (this.isFixedWeeks()) {
        // ensure 6 weeks
        range.end.add(6 - range.end.diff(range.start, "weeks"), "weeks");
      }
